...
describe('POST /api/v1/auth/signup', () => {
  it('Should create new order', (done) => {
    request(app)
      ...
      .send({
        email: 'longstride79@gmail.com',
        password: 'omoefedukes',
      })
      .expect(201)
      .end(done);
  });
...
//     request(app)
//       .post('/api/v1/parcels')
// .send(//   location: 'UBTH, Benin',
//   destination: 'Andela Epic Tower,  Ikorodu road, Lagos'//   email: 'omoefe.dukuye@gmail.com',
